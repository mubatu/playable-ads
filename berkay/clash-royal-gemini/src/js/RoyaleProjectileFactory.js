...
const SPHERE_GEO = new THREE.SphereGeometry(0.1, 10, 8);

/** Pooled spheres (same idea as `berkay/clash-of-clans` ProjectileFactory). */
export class RoyaleProjectileFactory {
    ...
    /** Enemy princess / auxiliary tower shots */
