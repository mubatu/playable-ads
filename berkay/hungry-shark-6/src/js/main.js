...
import { createShark } from './EntityFactory.js';
import { buildWorld, updateWorldEffects } from './WorldBuilder.js';
...
function startLoop(state) {
    function frame(now) {
        ...
        updateWorldEffects(state, delta);
...
function createGame(config) {
    ...
    var sharkGroup = createShark(config);
    state.sharkGroup = sharkGroup;
    state.worldGroup.add(sharkGroup);
